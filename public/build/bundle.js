...
/* src\TESTpost.svelte generated by Svelte v3.46.4 */
...
class TESTpost extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$5, create_fragment$5, safe_not_equal, { dark: 0, font: 1 });
...
function create_if_block_3$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br0, file$3, 33, 8, 745);
			add_location(h1, file$3, 34, 8, 759);
			add_location(br1, file$3, 35, 8, 791);
			attr_dev(textarea, "cols", "80");
			attr_dev(textarea, "row", "33");
			add_location(textarea, file$3, 36, 8, 805);
			add_location(br2, file$3, 37, 8, 883);
			add_location(h3, file$3, 38, 8, 897);
			add_location(br3, file$3, 39, 8, 926);
			attr_dev(input, "type", "search");
			attr_dev(input, "size", "60%");
			add_location(input, file$3, 40, 8, 940);
			add_location(br4, file$3, 40, 66, 998);
			add_location(p1, file$3, 41, 8, 1012);
			add_location(center, file$3, 32, 4, 727);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
...
// (23:4) {#each postsk['post_tech'] as post}
function create_each_block_1$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			hr = element("hr");
			add_location(h3, file$3, 24, 16, 554);
			add_location(strong, file$3, 24, 8, 546);
			add_location(center, file$3, 23, 4, 528);
			add_location(p1, file$3, 26, 4, 610);
			add_location(hr, file$3, 27, 4, 650);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(23:4) {#each postsk['post_tech'] as post}",
		ctx
	});
...
// (14:4) {#each postsk['post_nomal'] as post}
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			hr = element("hr");
			add_location(h3, file$3, 16, 16, 330);
			add_location(strong, file$3, 16, 7, 321);
			add_location(center, file$3, 15, 4, 304);
			add_location(p1, file$3, 18, 8, 394);
			add_location(hr, file$3, 19, 8, 438);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
			append_dev(center, strong);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(14:4) {#each postsk['post_nomal'] as post}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	function select_block_type(ctx, dirty) {
		...
		if (/*code*/ ctx[2] == 4) return create_if_block_3$1;
	}
	...
	const block = {
		c: function create() {
			...
			add_location(head, file$3, 8, 4, 166);
			add_location(hr, file$3, 11, 4, 229);
			attr_dev(body, "class", body_class_value = /*darkmode*/ ctx[0] + /*fontmode*/ ctx[1]);
			add_location(body, file$3, 10, 4, 191);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br, file$1, 108, 18, 4149);
			add_location(p1, file$1, 110, 16, 4197);
			add_location(center, file$1, 109, 16, 4171);
			add_location(div, file$1, 108, 12, 4143);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, br);
...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br0, file$1, 95, 16, 3658);
			add_location(br1, file$1, 95, 31, 3673);
			add_location(h1, file$1, 95, 20, 3662);
			add_location(br2, file$1, 95, 40, 3682);
			add_location(center, file$1, 94, 12, 3632);
			add_location(div, file$1, 93, 12, 3613);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, center);
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			br5 = element("br");
			hr1 = element("hr");
			add_location(br0, file$1, 80, 20, 3073);
			add_location(h2, file$1, 81, 20, 3099);
			add_location(br1, file$1, 82, 20, 3144);
			...
			add_location(img, file$1, 83, 20, 3170);
			add_location(br2, file$1, 84, 20, 3273);
			add_location(hr0, file$1, 85, 20, 3299);
			add_location(br3, file$1, 87, 58, 3404);
			add_location(br4, file$1, 87, 90, 3436);
			add_location(br5, file$1, 87, 120, 3466);
			add_location(hr1, file$1, 87, 124, 3470);
			attr_dev(p1, "class", "p-1");
			add_location(p1, file$1, 86, 20, 3325);
			add_location(center, file$1, 79, 16, 3043);
			add_location(div, file$1, 78, 12, 3020);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, center);
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br0, file$1, 66, 16, 2501);
			add_location(h3, file$1, 68, 20, 2553);
			add_location(br1, file$1, 69, 20, 2611);
			add_location(br2, file$1, 69, 24, 2615);
			attr_dev(ul, "class", "ul");
			add_location(ul, file$1, 70, 20, 2641);
			add_location(center, file$1, 67, 16, 2523);
			add_location(div, file$1, 65, 12, 2478);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, br0);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br0, file$1, 59, 17, 2104);
			add_location(h1, file$1, 60, 19, 2129);
			add_location(b, file$1, 60, 16, 2126);
			add_location(br1, file$1, 60, 53, 2163);
			add_location(br2, file$1, 61, 16, 2185);
			add_location(p10, file$1, 61, 20, 2189);
			add_location(br3, file$1, 62, 16, 2286);
			attr_dev(a, "href", "https://startbootstrap.com/template/simple-sidebar");
			add_location(a, file$1, 62, 32, 2302);
			add_location(p11, file$1, 62, 20, 2290);
			add_location(div, file$1, 59, 12, 2099);
			add_location(center, file$1, 58, 12, 2077);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 97, 16, 3751);
		},
		m: function mount(target, anchor) {
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 72, 61, 2763);
			attr_dev(a, "href", /*SNSone*/ ctx[14].href);
			add_location(a, file$1, 72, 37, 2739);
			attr_dev(il, "class", "il");
			add_location(il, file$1, 72, 20, 2722);
			add_location(br0, file$1, 72, 141, 2843);
			add_location(br1, file$1, 72, 145, 2847);
		},
		m: function mount(target, anchor) {
