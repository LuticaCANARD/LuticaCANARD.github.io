...
function create_fragment$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			h30 = element("h3");
			h30.textContent = "04 03 20:00";
			t3 = space();
			p10 = element("p1");
			t4 = text("가끔은 우울하다. 물속의 고요함을 다시 생각해봤다. 인생은 스펙트럼인걸 알고는 있지만, 문제는 이게 생각대로 믿어지질 않는다.");
			br0 = element("br");
			...
			h31 = element("h3");
			h31.textContent = "04 03 16:00";
			t23 = space();
			p12 = element("p1");
			t24 = text("나른하다. 이제는 무기력하지는 않지만 다시 나갔을때 무기력해질지 두렵다. 생각을 해보니 내 과거를 용납하던 잊던 어떻게든 떨쳐야한다. ");
			br13 = element("br");
			...
			h32 = element("h3");
			h32.textContent = "04 03 09:30";
			t35 = space();
			p13 = element("p1");
			t36 = text("마작을 쳐봤다. 매번 쳤지만, 병원에서 치기는 또 오랜만인것 같다. 마작을 칠떄 보면, 지다가도 역전을 하는 떄가 있기도 하고, 내가 원하던 패가 안나오곤 한다. ");
			br20 = element("br");
			...
			h33 = element("h3");
			h33.textContent = "04 02 14:30";
			t44 = space();
			p14 = element("p1");
			t45 = text("산책을 했다. 목련꽃이 피어있었다. 하얗고 나무같지만 꽃같기도 한 그 어중간한 느낌이 좋아서 나는 목련꽃을 좋아한다. 목련, 목련의 꽃말은 고귀함과 숭고함이라고 전해진다. 그 꽃과 아름다우면서도 투박한 그 모양에 걸맞는듯한 꽃말이 아닐까.");
			br24 = element("br");
			...
			h34 = element("h3");
			h34.textContent = "04 02 10:00";
			t55 = space();
			p15 = element("p1");
			t56 = text("휴학을 한게 약간은 후회가 되긴 한다. 하지만 생각해보면, 낮은 학점으로 나갈바에야 & 철도기술연구원 IPP도 못해볼 바에야 차라리 학교를 나가던지 쉬면서 일하고 상황이 나아지면 다시 학교로 오는게 저 낫겠지 싶다.");
			br31 = element("br");
			...
			h35 = element("h3");
			h35.textContent = "04 01 21:30";
			t62 = space();
			p16 = element("p1");
			t63 = text("어느날 문득 삶에 대한 회의가 들었다. 어떤 일이었는지는 모르지만, 무슨 일이 들어서 삶을 던지고 싶었다. 삶이 뭔데 나에게 이렇게 고통스럽게 하는지 모르겠다는 생각을 한다.");
			br34 = element("br");
			...
			h36 = element("h3");
			h36.textContent = "04 01 20:00";
			t72 = space();
			p17 = element("p1");
			t73 = text("예전에 자주 듣던 음악을 들었다. 이유는 모르겠지만 힘들때마다 듣기도 하고, 고통스러울때마다, 행복할때도 들었었다.");
			br39 = element("br");
			...
			add_location(br0, file$5, 11, 74, 239);
			add_location(br1, file$5, 12, 92, 337);
			add_location(br2, file$5, 13, 117, 460);
			add_location(br3, file$5, 14, 98, 564);
			add_location(br4, file$5, 15, 96, 666);
			add_location(br5, file$5, 16, 61, 733);
			add_location(br6, file$5, 17, 74, 813);
			add_location(br7, file$5, 18, 80, 899);
			add_location(p10, file$5, 11, 0, 165);
			add_location(h5, file$5, 19, 0, 910);
			add_location(br8, file$5, 19, 30, 940);
			add_location(br9, file$5, 20, 70, 1016);
			add_location(br10, file$5, 21, 58, 1080);
			add_location(br11, file$5, 22, 53, 1139);
			add_location(br12, file$5, 23, 90, 1235);
			add_location(p11, file$5, 19, 24, 934);
			add_location(hr1, file$5, 25, 0, 1302);
			add_location(h31, file$5, 27, 0, 1318);
			add_location(center1, file$5, 26, 0, 1308);
			add_location(br13, file$5, 29, 80, 1432);
			add_location(br14, file$5, 30, 49, 1487);
			add_location(br15, file$5, 31, 75, 1568);
			add_location(br16, file$5, 32, 32, 1606);
			add_location(br17, file$5, 33, 83, 1695);
			add_location(br18, file$5, 34, 75, 1776);
			add_location(br19, file$5, 35, 113, 1895);
			add_location(p12, file$5, 29, 0, 1352);
			add_location(hr2, file$5, 37, 0, 1932);
			add_location(h32, file$5, 39, 0, 1948);
			add_location(center2, file$5, 38, 0, 1938);
			add_location(br20, file$5, 41, 96, 2077);
			add_location(br21, file$5, 42, 74, 2157);
			add_location(br22, file$5, 43, 74, 2237);
			add_location(br23, file$5, 44, 104, 2347);
			add_location(p13, file$5, 41, 0, 1981);
			add_location(hr3, file$5, 46, 0, 2416);
			add_location(h33, file$5, 48, 0, 2432);
			add_location(center3, file$5, 47, 0, 2422);
			add_location(br24, file$5, 50, 137, 2604);
			add_location(br25, file$5, 51, 87, 2697);
			add_location(br26, file$5, 52, 68, 2771);
			add_location(br27, file$5, 53, 105, 2882);
			add_location(br28, file$5, 54, 110, 2998);
			add_location(br29, file$5, 55, 126, 3130);
			add_location(p14, file$5, 50, 0, 2467);
			add_location(br30, file$5, 56, 77, 3213);
			add_location(hr4, file$5, 57, 0, 3219);
			add_location(h34, file$5, 59, 0, 3235);
			add_location(center4, file$5, 58, 0, 3225);
			add_location(br31, file$5, 61, 124, 3392);
			add_location(br32, file$5, 62, 50, 3448);
			add_location(p15, file$5, 61, 0, 3268);
			add_location(br33, file$5, 63, 113, 3567);
			add_location(hr5, file$5, 64, 0, 3573);
			add_location(h35, file$5, 66, 4, 3593);
			add_location(center5, file$5, 65, 0, 3579);
			add_location(br34, file$5, 68, 102, 3728);
			add_location(br35, file$5, 69, 73, 3807);
			add_location(br36, file$5, 70, 99, 3912);
			add_location(br37, file$5, 71, 64, 3982);
			add_location(br38, file$5, 72, 96, 4084);
			add_location(p16, file$5, 68, 0, 3626);
			add_location(hr6, file$5, 74, 0, 4110);
			add_location(h36, file$5, 76, 8, 4138);
			add_location(center6, file$5, 75, 4, 4120);
			add_location(br39, file$5, 78, 68, 4244);
			add_location(br40, file$5, 79, 97, 4347);
			add_location(br41, file$5, 80, 87, 4440);
			add_location(br42, file$5, 81, 48, 4494);
			add_location(br43, file$5, 81, 52, 4498);
			add_location(br44, file$5, 82, 88, 4592);
			add_location(br45, file$5, 83, 48, 4646);
			add_location(p17, file$5, 78, 0, 4176);
			...
			add_location(iframe, file$5, 85, 0, 4668);
			add_location(center7, file$5, 84, 0, 4658);
