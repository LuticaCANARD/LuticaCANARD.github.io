...
function create_if_block_3$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br0, file$3, 36, 8, 851);
			add_location(h1, file$3, 37, 8, 865);
			add_location(br1, file$3, 38, 8, 897);
			attr_dev(textarea, "cols", "55");
			attr_dev(textarea, "row", "55");
			add_location(textarea, file$3, 39, 8, 911);
			add_location(br2, file$3, 40, 8, 989);
			add_location(h3, file$3, 41, 8, 1003);
			add_location(br3, file$3, 42, 8, 1032);
			attr_dev(input, "type", "search");
			attr_dev(input, "size", "60%");
			add_location(input, file$3, 43, 8, 1046);
			add_location(br4, file$3, 43, 66, 1104);
			add_location(p1, file$3, 44, 8, 1118);
			add_location(center, file$3, 35, 4, 833);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
...
function create_each_block_1$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			hr = element("hr");
			add_location(h3, file$3, 25, 16, 603);
			add_location(strong, file$3, 25, 8, 595);
			add_location(center, file$3, 24, 4, 577);
			add_location(p1, file$3, 27, 4, 659);
			add_location(hr, file$3, 28, 4, 699);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			hr = element("hr");
			add_location(h3, file$3, 17, 16, 379);
			add_location(strong, file$3, 17, 7, 370);
			add_location(center, file$3, 16, 4, 353);
			add_location(p1, file$3, 19, 8, 443);
			add_location(hr, file$3, 20, 8, 487);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
			append_dev(center, strong);
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(head, file$3, 9, 4, 215);
			add_location(hr, file$3, 12, 4, 278);
			attr_dev(body, "class", body_class_value = /*darkmode*/ ctx[0] + /*fontmode*/ ctx[1]);
			add_location(body, file$3, 11, 4, 240);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
