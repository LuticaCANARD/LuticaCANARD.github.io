...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			body = element("body");
			h1 = element("h1");
			h1.textContent = "TEST field~";
			add_location(head, file$4, 4, 0, 56);
			add_location(h1, file$4, 8, 4, 87);
			add_location(body, file$4, 7, 0, 75);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$4($$self, $$props, $$invalidate) {
	let { $$slots: slots = {}, $$scope } = $$props;
	validate_slots('TESTpost', slots, []);
	let { dark } = $$props;
	let { font } = $$props;
	const writable_props = ['dark', 'font'];

	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<TESTpost> was created with unknown prop '${key}'`);
	});
...
class TESTpost extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { dark: 0, font: 1 });
		...
		if (/*dark*/ ctx[0] === undefined && !('dark' in props)) {
			console.warn("<TESTpost> was created without expected prop 'dark'");
		}

		if (/*font*/ ctx[1] === undefined && !('font' in props)) {
			console.warn("<TESTpost> was created without expected prop 'font'");
		}
	}

	get dark() {
		throw new Error("<TESTpost>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set dark(value) {
		throw new Error("<TESTpost>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
...
function create_if_block_3$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t9 = space();
			p1 = element("p1");
			p1.textContent = "put in the json!";
			add_location(br0, file$3, 36, 8, 844);
			add_location(h1, file$3, 37, 8, 858);
			add_location(br1, file$3, 38, 8, 890);
			attr_dev(textarea, "cols", "55");
			attr_dev(textarea, "row", "55");
			add_location(textarea, file$3, 39, 8, 904);
			add_location(br2, file$3, 40, 8, 982);
			add_location(h3, file$3, 41, 8, 996);
			add_location(br3, file$3, 42, 8, 1025);
			attr_dev(input, "type", "search");
			attr_dev(input, "size", "60%");
			add_location(input, file$3, 43, 8, 1039);
			add_location(br4, file$3, 43, 66, 1097);
			add_location(p1, file$3, 44, 8, 1111);
			add_location(center, file$3, 35, 4, 826);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
			...
			set_input_value(input, /*input_text*/ ctx[3]);
			append_dev(center, br4);
...
function create_if_block_2$2(ctx) {
	...
	const block = {
		c: function create() {
			create_component(test_bed.$$.fragment);
		},
		m: function mount(target, anchor) {
			mount_component(test_bed, target, anchor);
			current = true;
		},
		p: function update(ctx, dirty) {
			const test_bed_changes = {};
			if (dirty & /*darkmode*/ 1) test_bed_changes.dark = /*darkmode*/ ctx[0];
			if (dirty & /*fontmode*/ 2) test_bed_changes.font = /*fontmode*/ ctx[1];
			test_bed.$set(test_bed_changes);
		},
		i: function intro(local) {
			if (current) return;
			transition_in(test_bed.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out(test_bed.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			destroy_component(test_bed, detaching);
		}
	};
...
// (24:4) {#each postsk['post_tech'] as post}
function create_each_block_1$2(ctx) {
	...
	let t1;
	let p1;
	let raw_value = /*post*/ ctx[6]['context'] + "";
	let t2;
	let hr;
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			hr = element("hr");
			add_location(h3, file$3, 25, 16, 596);
			add_location(strong, file$3, 25, 8, 588);
			add_location(center, file$3, 24, 4, 570);
			add_location(p1, file$3, 27, 4, 652);
			add_location(hr, file$3, 28, 4, 692);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(24:4) {#each postsk['post_tech'] as post}",
		ctx
	});
...
// (15:4) {#each postsk['post_nomal'] as post}
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			hr = element("hr");
			add_location(h3, file$3, 17, 16, 372);
			add_location(strong, file$3, 17, 7, 363);
			add_location(center, file$3, 16, 4, 346);
			add_location(p1, file$3, 19, 8, 436);
			add_location(hr, file$3, 20, 8, 480);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
			append_dev(center, strong);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(15:4) {#each postsk['post_nomal'] as post}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	let body_class_value;
	let current;
	const if_block_creators = [create_if_block$3, create_if_block_1$3, create_if_block_2$2, create_if_block_3$1];
	const if_blocks = [];

	function select_block_type(ctx, dirty) {
		if (/*code*/ ctx[2] == 1) return 0;
		if (/*code*/ ctx[2] == 2) return 1;
		if (/*code*/ ctx[2] == 3) return 2;
		if (/*code*/ ctx[2] == 4) return 3;
		return -1;
	}
	...
	const block = {
		c: function create() {
			...
			add_location(head, file$3, 9, 4, 208);
			add_location(hr, file$3, 12, 4, 271);
			attr_dev(body, "class", body_class_value = /*darkmode*/ ctx[0] + /*fontmode*/ ctx[1]);
			add_location(body, file$3, 11, 4, 233);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*darkmode, fontmode*/ 3 && body_class_value !== (body_class_value = /*darkmode*/ ctx[0] + /*fontmode*/ ctx[1])) {
				attr_dev(body, "class", body_class_value);
			}
		},
		i: function intro(local) {
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			center = element("center");
			p1 = element("p1");
			p1.textContent = "Welcome! , Building in progress";
			add_location(br, file$1, 111, 18, 4232);
			add_location(p1, file$1, 113, 16, 4280);
			add_location(center, file$1, 112, 16, 4254);
			add_location(div, file$1, 111, 12, 4226);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, br);
...
function create_if_block_4(ctx) {
	...
	const block = {
		c: function create() {
			p1 = element("p1");
			a = element("a");
			a.textContent = "Conqure X2";
			attr_dev(a, "href", "https://www.conquerx2.com/");
			add_location(a, file$1, 108, 16, 4131);
			add_location(p1, file$1, 108, 12, 4127);
		},
		m: function mount(target, anchor) {
			insert_dev(target, p1, anchor);
			append_dev(p1, a);
...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br0, file$1, 95, 16, 3609);
			add_location(br1, file$1, 95, 31, 3624);
			add_location(h1, file$1, 95, 20, 3613);
			add_location(br2, file$1, 95, 40, 3633);
			add_location(center, file$1, 94, 12, 3583);
			add_location(div, file$1, 93, 12, 3564);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, center);
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			br5 = element("br");
			hr1 = element("hr");
			add_location(br0, file$1, 80, 20, 3024);
			add_location(h2, file$1, 81, 20, 3050);
			add_location(br1, file$1, 82, 20, 3095);
			...
			add_location(img, file$1, 83, 20, 3121);
			add_location(br2, file$1, 84, 20, 3224);
			add_location(hr0, file$1, 85, 20, 3250);
			add_location(br3, file$1, 87, 58, 3355);
			add_location(br4, file$1, 87, 90, 3387);
			add_location(br5, file$1, 87, 120, 3417);
			add_location(hr1, file$1, 87, 124, 3421);
			attr_dev(p1, "class", "p-1");
			add_location(p1, file$1, 86, 20, 3276);
			add_location(center, file$1, 79, 16, 2994);
			add_location(div, file$1, 78, 12, 2971);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, center);
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br0, file$1, 66, 16, 2452);
			add_location(h3, file$1, 68, 20, 2504);
			add_location(br1, file$1, 69, 20, 2562);
			add_location(br2, file$1, 69, 24, 2566);
			attr_dev(ul, "class", "ul");
			add_location(ul, file$1, 70, 20, 2592);
			add_location(center, file$1, 67, 16, 2474);
			add_location(div, file$1, 65, 12, 2429);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, br0);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br0, file$1, 59, 17, 2055);
			add_location(h1, file$1, 60, 19, 2080);
			add_location(b, file$1, 60, 16, 2077);
			add_location(br1, file$1, 60, 53, 2114);
			add_location(br2, file$1, 61, 16, 2136);
			add_location(p10, file$1, 61, 20, 2140);
			add_location(br3, file$1, 62, 16, 2237);
			attr_dev(a, "href", "https://startbootstrap.com/template/simple-sidebar");
			add_location(a, file$1, 62, 32, 2253);
			add_location(p11, file$1, 62, 20, 2241);
			add_location(div, file$1, 59, 12, 2050);
			add_location(center, file$1, 58, 12, 2028);
		},
		m: function mount(target, anchor) {
			insert_dev(target, center, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(58:12) {#if context_mode == \\\"Home\\\"}",
		ctx
	});
...
// (97:16) {#each code_list as codenate}
function create_each_block_1$1(ctx) {
	let button;
	let t_value = /*codenate*/ ctx[17] + "";
	let t;
	let mounted;
	let dispose;

	function click_handler() {
		return /*click_handler*/ ctx[9](/*codenate*/ ctx[17]);
	}
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 97, 16, 3702);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(97:16) {#each code_list as codenate}",
		ctx
	});
...
// (72:20) {#each SNSs as SNSone}
function create_each_block$1(ctx) {
	let il;
	let a;
	let button;
	let t_value = /*SNSone*/ ctx[14].SNS_name + "";
	let t;
	let br0;
	let br1;
	...
	const block = {
		c: function create() {
			...
			br0 = element("br");
			br1 = element("br");
			attr_dev(button, "class", "btn btn-secondary active");
			add_location(button, file$1, 72, 61, 2714);
			attr_dev(a, "href", /*SNSone*/ ctx[14].href);
			add_location(a, file$1, 72, 37, 2690);
			attr_dev(il, "class", "il");
			add_location(il, file$1, 72, 20, 2673);
			add_location(br0, file$1, 72, 141, 2794);
			add_location(br1, file$1, 72, 145, 2798);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(72:20) {#each SNSs as SNSone}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	function select_block_type(ctx, dirty) {
		...
		if (/*context_mode*/ ctx[0] == "Other Site") return 4;
		return 5;
	}
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ('input_text_replace' in $$props) input_text_replace = $$props.input_text_replace;
...
// (74:20) {#each menu_listsk1 as menu (menu.id) }
function create_each_block_2(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(a, file, 74, 28, 3532);
			add_location(il, file, 74, 24, 3528);
			this.first = il;
		},
		m: function mount(target, anchor) {
			insert_dev(target, il, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(74:20) {#each menu_listsk1 as menu (menu.id) }",
		ctx
	});
...
// (85:111) {#if is_darkmode=="bg-white"}
function create_if_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(85:111) {#if is_darkmode==\\\"bg-white\\\"}",
		ctx
	});
...
// (89:32) {#each menu_listsk1 as drop}
function create_each_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(89:32) {#each menu_listsk1 as drop}",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a, "href", /*drop*/ ctx[17].href);
			add_location(a, file, 95, 40, 5521);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(95:40) {#each dropdown as drop}",
		ctx
	});
...
// (100:123) {#if is_darkmode=="bg-white"}
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(100:123) {#if is_darkmode==\\\"bg-white\\\"}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(meta0, "charset", "utf-8");
			add_location(meta0, file, 55, 8, 2551);
			attr_dev(meta1, "name", "viewport");
			attr_dev(meta1, "content", "width=device-width, initial-scale=1, shrink-to-fit=no");
			add_location(meta1, file, 56, 8, 2584);
			attr_dev(meta2, "name", "description");
			attr_dev(meta2, "content", "");
			add_location(meta2, file, 57, 8, 2681);
			attr_dev(meta3, "name", "author");
			attr_dev(meta3, "content", "");
			add_location(meta3, file, 58, 8, 2728);
			add_location(title, file, 59, 8, 2770);
			attr_dev(link0, "rel", "icon");
			attr_dev(link0, "type", "image/x-icon");
			attr_dev(link0, "href", "assets/favicon.ico");
			add_location(link0, file, 61, 8, 2859);
			attr_dev(link1, "href", "../build/styles.css");
			attr_dev(link1, "rel", "stylesheet");
			add_location(link1, file, 63, 8, 2985);
			add_location(head, file, 54, 4, 2536);
			attr_dev(div0, "class", div0_class_value = "sidebar-heading border-bottom" + /*is_darkmode_light*/ ctx[1] + /*font_mode*/ ctx[2]);
			add_location(div0, file, 71, 15, 3292);
			attr_dev(div1, "class", "list-group list-group-flush");
			add_location(div1, file, 72, 16, 3402);
			...
			add_location(div2, file, 70, 12, 3184);
			attr_dev(button0, "class", "btn btn-primary");
			attr_dev(button0, "id", "sidebarToggle");
			add_location(button0, file, 84, 24, 4109);
			attr_dev(span, "class", "navbar-toggler-icon");
			add_location(span, file, 85, 228, 4490);
			...
			add_location(button1, file, 85, 24, 4286);
			...
			add_location(div4, file, 93, 36, 5316);
			attr_dev(li, "class", "nav-item dropdown");
			add_location(li, file, 91, 32, 5050);
			attr_dev(ul, "class", "navbar-nav ms-auto mt-2 mt-lg-0");
			add_location(ul, file, 87, 28, 4681);
			...
			add_location(script, file, 117, 8, 6491);
			attr_dev(div9, "class", "d-flex");
			attr_dev(div9, "id", "wrapper");
			add_location(div9, file, 68, 8, 3110);
			attr_dev(body, "class", /*is_darkmode_light*/ ctx[1]);
			add_location(body, file, 67, 4, 3067);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
