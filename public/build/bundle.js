...
function create_fragment$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			h30 = element("h3");
			h30.textContent = "04 03 16:00";
			t3 = space();
			p10 = element("p1");
			t4 = text("나른하다. 이제는 무기력하지는 않지만 다시 나갔을때 무기력해질지 두렵다. 생각을 해보니 내 과거를 용납하던 잊던 어떻게든 떨쳐야한다. ");
			br0 = element("br");
			...
			t15 = space();
			p11 = element("p1");
			t16 = text("마작을 쳐봤다. 매번 쳤지만, 병원에서 치기는 또 오랜만인것 같다. 마작을 칠떄 보면, 지다가도 역전을 하는 떄가 있기도 하고, 내가 원하던 패가 안나오곤 한다. ");
			br7 = element("br");
			...
			t24 = space();
			p12 = element("p1");
			t25 = text("산책을 했다. 목련꽃이 피어있었다. 하얗고 나무같지만 꽃같기도 한 그 어중간한 느낌이 좋아서 나는 목련꽃을 좋아한다. 목련, 목련의 꽃말은 고귀함과 숭고함이라고 전해진다. 그 꽃과 아름다우면서도 투박한 그 모양에 걸맞는듯한 꽃말이 아닐까.");
			br11 = element("br");
			...
			t35 = space();
			p13 = element("p1");
			t36 = text("휴학을 한게 약간은 후회가 되긴 한다. 하지만 생각해보면, 낮은 학점으로 나갈바에야 & 철도기술연구원 IPP도 못해볼 바에야 차라리 학교를 나가던지 쉬면서 일하고 상황이 나아지면 다시 학교로 오는게 저 낫겠지 싶다.");
			br18 = element("br");
			...
			t42 = space();
			p14 = element("p1");
			t43 = text("어느날 문득 삶에 대한 회의가 들었다. 어떤 일이었는지는 모르지만, 무슨 일이 들어서 삶을 던지고 싶었다. 삶이 뭔데 나에게 이렇게 고통스럽게 하는지 모르겠다는 생각을 한다.");
			br21 = element("br");
			...
			t52 = space();
			p15 = element("p1");
			t53 = text("예전에 자주 듣던 음악을 들었다. 이유는 모르겠지만 힘들때마다 듣기도 하고, 고통스러울때마다, 행복할때도 들었었다.");
			br26 = element("br");
			...
			add_location(br0, file$5, 11, 80, 245);
			add_location(br1, file$5, 12, 49, 300);
			add_location(br2, file$5, 13, 75, 381);
			add_location(br3, file$5, 14, 32, 419);
			add_location(br4, file$5, 15, 83, 508);
			add_location(br5, file$5, 16, 75, 589);
			add_location(br6, file$5, 17, 113, 708);
			add_location(p10, file$5, 11, 0, 165);
			add_location(hr1, file$5, 19, 0, 745);
			add_location(h31, file$5, 21, 0, 761);
			add_location(center1, file$5, 20, 0, 751);
			add_location(br7, file$5, 23, 96, 890);
			add_location(br8, file$5, 24, 74, 970);
			add_location(br9, file$5, 25, 74, 1050);
			add_location(br10, file$5, 26, 104, 1160);
			add_location(p11, file$5, 23, 0, 794);
			add_location(hr2, file$5, 28, 0, 1229);
			add_location(h32, file$5, 30, 0, 1245);
			add_location(center2, file$5, 29, 0, 1235);
			add_location(br11, file$5, 32, 137, 1417);
			add_location(br12, file$5, 33, 87, 1510);
			add_location(br13, file$5, 34, 68, 1584);
			add_location(br14, file$5, 35, 105, 1695);
			add_location(br15, file$5, 36, 110, 1811);
			add_location(br16, file$5, 37, 126, 1943);
			add_location(p12, file$5, 32, 0, 1280);
			add_location(br17, file$5, 38, 77, 2026);
			add_location(hr3, file$5, 39, 0, 2032);
			add_location(h33, file$5, 41, 0, 2048);
			add_location(center3, file$5, 40, 0, 2038);
			add_location(br18, file$5, 43, 124, 2205);
			add_location(br19, file$5, 44, 50, 2261);
			add_location(p13, file$5, 43, 0, 2081);
			add_location(br20, file$5, 45, 113, 2380);
			add_location(hr4, file$5, 46, 0, 2386);
			add_location(h34, file$5, 48, 4, 2406);
			add_location(center4, file$5, 47, 0, 2392);
			add_location(br21, file$5, 50, 102, 2541);
			add_location(br22, file$5, 51, 73, 2620);
			add_location(br23, file$5, 52, 99, 2725);
			add_location(br24, file$5, 53, 64, 2795);
			add_location(br25, file$5, 54, 96, 2897);
			add_location(p14, file$5, 50, 0, 2439);
			add_location(hr5, file$5, 56, 0, 2923);
			add_location(h35, file$5, 58, 8, 2951);
			add_location(center5, file$5, 57, 4, 2933);
			add_location(br26, file$5, 60, 68, 3057);
			add_location(br27, file$5, 61, 97, 3160);
			add_location(br28, file$5, 62, 87, 3253);
			add_location(br29, file$5, 63, 48, 3307);
			add_location(br30, file$5, 63, 52, 3311);
			add_location(br31, file$5, 64, 88, 3405);
			add_location(br32, file$5, 65, 48, 3459);
			add_location(p15, file$5, 60, 0, 2989);
			...
			add_location(iframe, file$5, 67, 0, 3481);
			add_location(center6, file$5, 66, 0, 3471);
